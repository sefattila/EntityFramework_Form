...
namespace _3_NorthwindCompany.AppDbContext
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<CustomerOrdersSummary> CustomerOrdersSummaries { get; set; } = null!;
        public virtual DbSet<Employee> Employees { get; set; } = null!;
        public virtual DbSet<Invoice> Invoices { get; set; } = null!;
        public virtual DbSet<MusteriSipari> MusteriSiparis { get; set; } = null!;
        ...
        public virtual DbSet<ProductOrderSummary> ProductOrderSummaries { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KDK-403-PC13-YZ;Database=Northwind;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerOrdersSummary>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("CustomerOrdersSummary");
            ...
            modelBuilder.Entity<MusteriSipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("MusteriSiparis");
            ...
            modelBuilder.Entity<ProductOrderSummary>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ProductOrderSummary");
